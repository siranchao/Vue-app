...
<template>
    <div class="table">
        ...
        <div class="table-container">
            <div class="table-col">
                <FoodsRow :isHeader="true" />
                <FoodsRow v-for="(restaurant, index) in restaurantsOrganized.first" :key="restaurant.id"
                    :name="restaurant.name" :rank="restaurant.rank" :index="index" />
            </div>
            <div class="table-col">
                <FoodsRow :isHeader="true" />
                <FoodsRow v-for="(restaurant, index) in restaurantsOrganized.second" :key="restaurant.id"
                    :name="restaurant.name" :rank="restaurant.rank" :index="index" />
            </div>
        </div>
    </div>
